...
// creating the view
const view = new View({
  center: fromLonLat([-40.403812, -20.287962]),
  zoom: 20
});
...
const vectorLayer = new VectorLayer({
  ...
  source: new VectorSource({
    format: new GeoJSON(),
    url: "../rotas_geojson/rota.geojson",
  }),
...
function addPosition(position, heading, m, speed) {
  ...
  if (heading && speed) {
    markerEl.src = "/main/img/geolocation_marker_heading.png";
  } else {
    markerEl.src = "main/img/geolocation_marker.png";
  }
}
...
client.open('GET', '../geolocation/geolocation-orientation.json');
